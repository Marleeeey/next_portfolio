        ...
        <div className="w-full h-full flex items-center justify-around flex-wrap">
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            ...
            <p className="flex items-center my-[15px] cursor-pointer">
              ...
              <span className="text-[15px] ml-[6px]">Brahim elmliji</span>
            </p>
            {/* Instagram */}
            <p className="flex items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px]">A fullstack Developer</span>
            </p>
            {/* LinkdIn */}
            <p className="flex items-center my-[15px] cursor-pointer">
            ...
            {/* Discord */}
            <p className="flex items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px]">ibrahim.elmliji01@gmail.com</span>
            </p>
          </div>
        </div>
      </div>
